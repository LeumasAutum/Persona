...
def profile(request,pk):
    ...
    if request.user != user:
        ...
        # Redirect to an error page or display a message indicating no permission

        return render(request, 'Accounts/error.html', {'message': 'You can do better than an IDOR.....Go back to your profile :)'})
